...
class Backbone_VSSM(VSSM):
    ...
    def forward(self, x):
        ...
        for i, layer in enumerate(self.layers):
            #if i == 0:
            #    print("Input layer 0 x shape:", x.shape)

            # input for each stage of Mamba
            ...
            if i in self.out_indices:
                ...
                # calculate the high frequency part
                x_high = x_in - out
                outs_high.append(x_high)

            #print("Layer", i, "o and x shape:", o.shape, x.shape)

        if len(self.out_indices) == 0:
            return x
        
        return outs, outs_high
